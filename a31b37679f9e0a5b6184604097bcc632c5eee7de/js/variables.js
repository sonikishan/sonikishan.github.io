...
var	mobileMenuTitle = "Menu",					//The title of the mobile menu
	...
	map_initial_latitude = 22.5467592, //8.457197,			//Google map initial Latitude. If "null", the latitude of the first marked will be used
	map_initial_longitude = 72.9294917, //77.0519041,		    //Google map initial Longitude. If "null", the longitude of the first marked will be used
